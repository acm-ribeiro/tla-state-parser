...
public class TLAStateParser extends Parser {
	...
	public static final int
		...
		RULE_bodyRecord = 28, RULE_bodyType = 29, RULE_bodyInt = 30, RULE_bodyBool = 31, 
		RULE_bodyObject = 32, RULE_objectRecord = 33;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"parameters", "body", "paramRecord", "bodyRecord", "bodyType", "bodyInt", 
			"bodyBool", "bodyObject", "objectRecord"
		};
	}
	...
	public final BodyIntContext bodyInt() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_bodyInt);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(296);
	...
	public final BodyBoolContext bodyBool() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_bodyBool);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(300);
	...
	public final BodyObjectContext bodyObject() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_bodyObject);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(304);
	...
	public final ObjectRecordContext objectRecord() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_objectRecord);
		int _la;
		try {
			setState(327);
			_errHandler.sync(this);
